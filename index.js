...
const consumption = async ({ type, mp, sn, cost, writeApi }) => {
    ...
    const logmsg = `Polling ${type} consumption data from octopus API`;
    console.log(logmsg);
...
//        tariff(writeApi)
//            .then(() => {
//                console.log('Successfully polled tariff data');
//            })
//            .catch(e => {
//                console.error(e);
//                console.log('Error Polling tariff data');
//            });
        ...
        await consumption({
            ...
            .then(() => {
                console.log('Successfully polled electricity consumption data');
            })
            .catch(e => {
                console.error(e);
                console.log('Error Polling electricity consumption data');
            });
        ...
        await consumption({
            ...
            .then(() => {
                console.log('Successfully polled gas consumption data');
            })
            .catch(e => {
                console.error(e);
                console.log('Error Polling gas consumption data');
            });

        console.log("Polling tariff data from octopus API");
        await Promise.all([tariff(writeApi)])
            .then( () => {
                console.log('Successfully polled tariff data');
            })
            .catch((e) => {
